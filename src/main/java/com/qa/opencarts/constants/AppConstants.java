package com.qa.opencarts.constants;
...
public class AppConstants {
	...
	public static final String USER_REGISTER_SUCCESS_MESSG = "Your Account Has Been Created!";
		...
		public static final List<String> EXPECTED_PAGE_HEADERS_LIST=List.of("My Account","My Orders", "My Affiliate Account", "Newsletter");	
	
		//****************Sheet names*************//
		public static final String REG_SHEETNAME = "register";
