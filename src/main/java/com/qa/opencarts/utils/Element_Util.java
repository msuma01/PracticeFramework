...
import com.qa.opencarts.exceptions.Suggestions_Exception;
...
public class Element_Util {
	...
	/*
	 * This is a constructor used to initialize the global variable
	 * 
	 */
	...
	public void doSendKeysclear(WebElement element, String value) {
		element.clear();
	...
	public boolean doSearch(By searchField, By suggestions, String searchkey, String matchvalue)
		...
		if (totalSuggestions == 0) {
			...
			throw new Suggestions_Exception("******** NO SUGGESTIONS FOUND************");
		}
